...
gs_stage_surface::gs_stage_surface(gs_device_t *device, uint32_t width,
	...
	: gs_stage_surface(device, width, height, colorFormat, false)
{
}
...
gs_stage_surface::gs_stage_surface(gs_device_t *device, uint32_t width,
				   uint32_t height, gs_color_format colorFormat,
				   bool write)
	: gs_stage_surface(device, width, height, colorFormat,
			   ConvertGSTextureFormat(colorFormat), write)
{
}
...
gs_stage_surface::gs_stage_surface(gs_device_t *device, uint32_t width,
	...
	: gs_stage_surface(device, width, height, colorFormat, dxgiColorFormat,
			   false)
{
}
